...
> We do not consider Meta-Analyses here today, otherwhise...
...
- Question
  ...
  - find-raplace / copy-paste search strings
...
- Screening
  ...
  - use distinct colors for distincts keyvords
...
The algorithm compares its current inferred output with the correct one, so that to learn from its .orange[errors] (to minimize it).
...
Select some (initialy random) weights $W$, do the math, obtain a results.

Compare it with the true result, and obtain the error, i.e., a number.

(If the nonlinearity $g$ satisfy good mathematical requirements...)
<br>
<br>
<br>
...
### Question
- How can we make my search string suitable for multiple DBs?
...
- http://systematicreviewtools.com , a web-based catalogue of tools that support various tasks within the systematic review and wider evidence synthesis process. It was orignally developed by .orange[Dr Christopher Marshall and Anthea Sutton], launching in 2014. 
